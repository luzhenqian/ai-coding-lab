  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 lg:px-8">
      ...
      <CommentList
        ...
        initialComments={article.comments.map(serializeComment)}
        initialNextCursor={
          article.comments.length >= 20
            ? article.comments[article.comments.length - 1].id
            : null
        }
        initialTotal={article._count.comments}
      />
    </main>
  );
}
